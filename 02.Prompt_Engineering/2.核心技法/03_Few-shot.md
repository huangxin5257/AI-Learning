...
本文聚焦于 Few-shot 的**底层机制**——格式契约/风格对齐/推理模式三种作用层次、近因偏差、分布匹配等。关于 Few-shot 的操作实践，官方文档可补充参考：

- [Claude Prompting Best Practices](https://platform.claude.com/docs/en/build-with-claude/prompt-engineering/claude-prompting-best-practices) — 重点参考"Use examples effectively"节（官方推荐 3-5 个示例，与本文结论一致）